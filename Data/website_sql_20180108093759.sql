...
CREATE TABLE `en_expert` (
  ...
  `indicator_id` int(5) NOT NULL COMMENT '一级指标',
  `expert_desc` char(20) DEFAULT NULL COMMENT '专家简介',
  `year_id` int(5) DEFAULT NULL COMMENT '评审年份id',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='专家表';/* SqlEnd */

-- -----------------------------
-- Records of ``en_expert``
-- -----------------------------
INSERT INTO `en_expert` VALUES ('4','专家11','1','123','');/* SqlEnd */
...
-- -----------------------------
INSERT INTO `en_member` VALUES ('1','admin','21232f297a57a5a743894a0e4a801fc3','','0','13445678989','admin@qq.com','1492764255','127.0.0.1','0','','1');/* SqlEnd */



-- -----------------------------
-- Table structure for `en_museum`
-- -----------------------------
DROP TABLE IF EXISTS `en_museum`;/* SqlEnd */
CREATE TABLE `en_museum` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `name` char(10) NOT NULL,
  `museum_type_id` int(5) NOT NULL,
  `museum_level_id` int(5) NOT NULL,
  `year_id` text NOT NULL COMMENT '评审年份',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='博物馆';/* SqlEnd */




-- -----------------------------
-- Table structure for `en_museum_level`
-- -----------------------------
DROP TABLE IF EXISTS `en_museum_level`;/* SqlEnd */
CREATE TABLE `en_museum_level` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `name` char(10) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='博物馆级别';/* SqlEnd */

-- -----------------------------
-- Records of ``en_museum_level``
-- -----------------------------
INSERT INTO `en_museum_level` VALUES ('1','省馆及省级以上'),('2','其他');/* SqlEnd */



-- -----------------------------
-- Table structure for `en_museum_type`
-- -----------------------------
DROP TABLE IF EXISTS `en_museum_type`;/* SqlEnd */
CREATE TABLE `en_museum_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` char(10) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='博物馆类型';/* SqlEnd */

-- -----------------------------
-- Records of ``en_museum_type``
-- -----------------------------
INSERT INTO `en_museum_type` VALUES ('1','历史文化与综合类'),('2','自然、科技与专题类'),('3','纪念类'),('4','遗址类');/* SqlEnd */
...
-- -----------------------------
-- Table structure for `en_year`
-- -----------------------------
DROP TABLE IF EXISTS `en_year`;/* SqlEnd */
CREATE TABLE `en_year` (
  `id` int(5) NOT NULL AUTO_INCREMENT,
  `name` varchar(4) NOT NULL COMMENT '年份',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='；评审年份';/* SqlEnd */

-- -----------------------------
-- Records of ``en_year``
-- -----------------------------
INSERT INTO `en_year` VALUES ('1','2015'),('2','2016'),('3','2017'),('4','2018');/* SqlEnd */
