...
<body>
    ...
    <assign name="Think.get.year_id" value="<script>$('select').val()</script>"/>
    <script>
        ...
        <div class="col-lg-6 form-group" style="float: left">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                        <button class="btn btn-default" id="search_expert"  type="button">搜索</button>
                    </span>
            </div><!-- /input-group -->
        </div><!-- /.col-lg-6 -->
    </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php if(empty($expert_list1)): ?><span style="color: red;">暂无用户</span>
                <?php else: ?>
                <table class="table table-hover table-condensed table-bordered table_list">
                    ...
                    <?php if(is_array($expert_list1)): $k = 0; $__LIST__ = $expert_list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                            ...
                            <td align="center"><?php echo ($vo["indicator"]); ?></td>
                            <td align="center">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php if(empty($expert_list2)): ?><span style="color: red;">暂无用户</span>
                <?php else: ?>
                <table class="table table-hover table-condensed table-bordered table_list">
                    <thead>
                    <tr class="active">
                    ...
                    <tbody>
                    <?php if(is_array($expert_list2)): $i = 0; $__LIST__ = $expert_list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
